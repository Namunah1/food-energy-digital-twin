...
MASTER_SEED  = 42
N_STEPS_MAIN = 30   # paper horizon
N_MC_RETRO   = 30   # Monte Carlo runs for retrodiction
N_MC_SCEN    = 20   # Monte Carlo runs per scenario
N_SOBOL      = 16   # Sobol sample size (224 total runs)
N_OAT_LEVELS = 8    # OAT levels per parameter
